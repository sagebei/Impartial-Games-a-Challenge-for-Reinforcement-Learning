...
class MCTS:
    ...
    def run(self, state, to_play, is_train=True):
        ...
        self.game.set_board(copy.deepcopy(state))  # initialize the game using the current board
        ...
        action_masks = self.game.get_action_masks()  # obtain the action mask
        ...
        for _ in range(self.args['num_simulations']):
            ...
            self.game.set_board(copy.deepcopy(parent.state))
